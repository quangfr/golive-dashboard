...
| **COCKPIT WORKSCOPE** Léo. | 🟢 Produit orienté data sous-valorisé                  | 🌴 Créer un espace d'échange avec les opérationnels | 📍GOAL DIGGER : Valoriser le produit via une meilleure traduction des enjeux métiers                 |
...
| **COCKPIT WORKSCOPE** Léo. | Suivre les prescriptions de maintenance des moteurs                          | - Délai de prise en charge des nouveaux besoins (FTM/shops)  <br> - Utilisation effective des rapports livrés  <br> - Taux d’utilisation des rapports par les entités | Multiplier et soigner la communication sur les réalisations au métier |
